...
tf.compat.v1.disable_eager_execution()  # Enable TF1 behavior

def load_graph(model_file):
    graph = tf.Graph()
    graph_def = tf.compat.v1.GraphDef()  # TF1 compatibility
...
def main(img):
    ...
    model_file = os.path.join(base_path, "retrained_graph.pb")
    label_file = os.path.join(base_path, "retrained_labels.txt")
